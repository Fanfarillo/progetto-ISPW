...
public class ControllerGuiWriteReview {
    ...
    void initialize() {
        ...
        assert chooseRestButton != null : "fx:id=\"chooseRestButton\" was not injected: check your FXML file 'WriteReviewView.fxml'.";
        assert scheduleButton != null : "fx:id=\"scheduleButton\" was not injected: check your FXML file 'WriteReviewView.fxml'.";
