...
public class BeanCheckedRestaurantSchedule {
	...
	public BeanCheckedRestaurantSchedule(Date date1, boolean atLunch1, Date date2, boolean atLunch2, String city, boolean vegan, boolean celiac, double budget, int quality) {
		this.date1=date1;
